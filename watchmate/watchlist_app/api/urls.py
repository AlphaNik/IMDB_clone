...
urlpatterns = [
    ...
    # path('streaming-platforms/', views.StreamPlatformAV.as_view(), name='streams'), 
    # path('streaming-platforms/<int:id>/', views.StreamPlatformDetailAV.as_view(), name='streams-detail'),
    ...
    #below are 3 ways to filter reviews
